        ...
        <div className="space-y-4">
                ...
                <div className="flex-1 flex items-center space-x-2">
                  ...
                  {!isAdvancedMode && (
                    <button
                      type="submit"
                      disabled={isSubmitting || isLoading}
                      className={`flex items-center space-x-2 px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed`}
                    >
          ...
          {bulkMode && (
            <button
              type="submit"
              disabled={isSubmitting || isLoading}
              className={`w-full flex items-center justify-center space-x-2 px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed`}
            >
              {(isSubmitting || isLoading) ? (
                <LoadingSpinner size="small" />
              ) : (
